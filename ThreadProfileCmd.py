...
class ThreadProfileCreateObjectCommandClass(object):
    ...
    def makeThreadProfile(self,name="VThreadProfile",minor_diameter=4.773,pitch=1,internal_or_external="External",internal_data=[],external_data=[],presets=[],thread_count=10,Quality=11):
